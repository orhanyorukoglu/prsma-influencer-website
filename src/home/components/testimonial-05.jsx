        ...
        <div className="grid grid-cols-1 gap-y-12 md:grid-cols-2 md:gap-x-8 lg:gap-16">
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="heading-h6 font-bold">
              "Using this app has taken my content to the next level! I highly
              recommend it to all influencers."
            </blockquote>
            <div className="mt-6 flex w-full flex-col gap-3 md:mt-8 md:w-auto md:flex-row md:items-center md:gap-5">
              <div>
                <img
                  src="/images/AdobeStock_306557633.jpeg"
                  alt="Emily Johnson - Content Creator"
          ...
          <div className="flex h-full max-w-lg flex-col items-start justify-start text-left">
            ...
            <blockquote className="heading-h6 font-bold">
              "The analytics provided are invaluable for growth. I can see real
              results!"
            </blockquote>
            <div className="mt-6 flex w-full flex-col gap-3 md:mt-8 md:w-auto md:flex-row md:items-center md:gap-5">
              <div>
                <img
                  src="/images/AdobeStock_321394130.jpeg"
                  alt="Michael Smith - Social Media Manager"
                  className="size-14 min-h-14 min-w-14 rounded-full object-cover"
                />
              </div>
              <div className="mb-4 md:mb-0">
